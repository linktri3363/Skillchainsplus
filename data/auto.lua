...
-- THIEF - FIXED: Standardized amws with Linktri.lua
...
-- BLUE MAGE - FIXED: Added proper weaponskill configurations and added Chain Affinity functionality

if info.job == 'BLU' then
    defaultws = {'Chant du Cygne', 'Savage Blade', 'Requiescat'}
    tpws = {'Chant du Cygne'}
    spamws = {'Chant du Cygne', 'Savage Blade'}
    cleavews = {'Aeolian Edge'}
    starterws = {'Chant du Cygne', 'Savage Blade'}
    preferws = {'Chant du Cygne', 'Expiacion'}
    amws = 'Expiacion'
